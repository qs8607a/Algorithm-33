...
double costMedian[10][10][10][10][10];//保存中间结果的数组
...
double getMinCost(int y1,int y2,int y3,int y4,int y5)
{
	...
	//判断是否是已经计算过的子问题
	if (costMedian[y1][y2][y3][y4][y5] > 0)
		return costMedian[y1][y2][y3][y4][y5];
	...
	if(!y1 && !y2 && !y3 && !y4 && !y5)
		...
		return (costMedian[y1][y2][y3][y4][y5] = minFiveValues(num * price * (1 - discount[num - 1]) + 
		getMinCost(y1 - 1,y2 - 1,y3 - 1,y4 - 1,y5 - 1),
		...
		return  (costMedian[y1][y2][y3][y4][y5] = minFiveValues(MaxValue,
		(num - 1) * price * (1 - discount[num - 2]) + getMinCost(y1 - 1,y2 - 1,y3 - 1,y4 - 1,y5),
		(num - 2) * price * (1 - discount[num - 3]) + getMinCost(y1 - 1,y2 - 1,y3 - 1,y4,y5),
		(num - 3) * price * (1 - discount[num - 4]) + getMinCost(y1 - 1,y2 - 1,y3,y4,y5),
		price + getMinCost(y1 - 1,y2,y3,y4,y5)));
		...
		return  (costMedian[y1][y2][y3][y4][y5] = min((num - 3) * price * (1 - discount[num - 4]) + getMinCost
		(y1 - 1,y2 - 1,y3,y4,y5),
		price + getMinCost(y1 - 1,y2,y3,y4,y5)));
	else if(y1 >= 1)
		return  (costMedian[y1][y2][y3][y4][y5] = price + getMinCost(y1 - 1,y2,y3,y4,y5));
}
